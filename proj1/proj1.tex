...
\begin{quotation}
    Čím více \textit{druhů}, \textbf{řezů}, {\huge velikostí}, {\color{blue} barev} písma a jiných \textsc{\color{red} efektů} \underline{použijeme}, tím {\color{orange} profesionálněji} bude {\fontfamily{pzc}\selectfont \Large dokument} vypadat.
